...
sudo nala install build-essential procps curl file wget git gimp krita inkscape thunderbird htop stacer okular calibre flameshot lutris kazam kadenlive gnome-software redshift gnome-software discover clamav clamtk synaptic qt5-style-kvantum python3.10-venv ueberzug luarocks xclip qbittorrent gpm ibus-avro -y --install-suggests
